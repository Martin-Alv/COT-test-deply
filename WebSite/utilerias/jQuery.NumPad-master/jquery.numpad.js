...
(function($){
	...
	*/
	...
	$.fn.numpad.defaults = {
		...
		gridTpl: '<table></table>',
		displayTpl: '<input type="text" class="inputvalue" />',
		displayCellTpl: '<td colspan="4" class="tdinputvalue"></td>',
		rowTpl: '<tr class="trnumpad"></tr>',
		cellTpl: '<td class="tdnumpad"></td>',
		buttonNumberTpl: '<button class="btnnumpad"></button>',
		buttonFunctionTpl: '<button class="btnnumpad"></button>',
		gridTableClass: '',
