...
namespace eaton.Rules
{
    public partial class Handler_Ultima_Carga_Etiqueta : eaton.Rules.SharedBusinessRules
    {
        ...
        /// <summary>Rule "Generar_Todas_Etiquetas" implementation:
        /// This method will execute in any view for an action
        /// with a command name that matches "Report" and argument that matches "ExecCS07".
        /// </summary>
        [Rule("r112")]
        public void r112Implementation(Etiqueta_Proveedor1_1Model instance)
        {
