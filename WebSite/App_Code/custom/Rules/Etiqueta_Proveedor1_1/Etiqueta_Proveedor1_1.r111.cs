...
namespace eaton.Rules
{
    public partial class Handler_Ultima_Carga_Etiqueta : eaton.Rules.SharedBusinessRules
    {
        ...
        /// <summary>Rule "Generar Etiqueta" implementation:
        /// This method will execute in any view for an action
        /// with a command name that matches "Report" and argument that matches "ExecCS06".
        /// </summary>
        [Rule("r111")]
        public void r111Implementation(Etiqueta_Proveedor1_1Model instance)
        {
            ...
            //EN ESTE BR SE CONSERVARA LA LOGICA PARA EVITAR ERRORES FUTUROS DE COMENTADO.
