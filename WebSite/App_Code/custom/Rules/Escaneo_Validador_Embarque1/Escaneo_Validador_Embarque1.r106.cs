...
namespace eaton.Rules
{
    public partial class Escaneo_Validador_Embarque1BusinessRules : eaton.Rules.SharedBusinessRules
    {
        ...
        /// </summary>
        [Rule("r106")]
        public void r106Implementation(Escaneo_Validador_Embarque1Model instance)
        {
            ...
            //Datos extras
            int Validar = 0;//Campo que indica al sp que debe registrar a bitacora y a app.Escaneo
            int Seccion_Capturada = instance.Seccion_Capturada ?? 0;


            //long Escaneo_Validador_Embarque_Id = instance.Folio_Escaneo_Id ?? 0;
            //long Escaneo_Validador_Embarque_Id_Out = instance.Folio_Escaneo_Id ?? 0;
