...
namespace eaton.Rules
{
	public partial class Grid_Material_Pte_Por_Surtir_Excedente_VBusinessRules : eaton.Rules.SharedBusinessRules
    {
        ...
        /// </summary>
        [Rule("r100")]
        public void r100Implementation(Grid_Material_Pte_Por_Surtir_Excedente_VModel instance)
        {
            ...
            else
            {
                resultadoEjecucion = GenerarSolicitudMaterial(
                    ...
                    ,AreaServicioId
                    ,FamiliaId
                    , 12 //Solicitud creado desde edicion de material pte por surtir excedente.
                    //---                
                    , out MensajeSistema
       ...
       // END public void r100Implementation(Grid_Material_Pte_Por_Surtir_Excedente_VModel instance)
    }
}
