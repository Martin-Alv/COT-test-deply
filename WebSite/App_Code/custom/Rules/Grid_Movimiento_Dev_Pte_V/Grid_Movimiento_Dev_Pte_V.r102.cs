...
{
	public partial class Grid_Movimiento_Dev_Pte_VBusinessRules : eaton.Rules.SharedBusinessRules
    {
        ...
        /// </summary>
        [Rule("r102")]
        //START public void r102Implementation(Grid_Movimiento_Dev_Pte_VModel instance)
        public void r102Implementation(Grid_Movimiento_Dev_Pte_VModel instance)
        {
            ...
            else
            {
                ...
                {
                    Result.ShowMessage(MensajeSistema);
                    Result.ExecuteOnClient("window.location.replace('Mov_Dev_Ruta_Optima_A_Ejecutar_V?Tmp_Ruta_Optima_Transaccion_Id=" + tmpMovRutaOptimaTransaccionId + "')");
                }
            }// END else
        }
        //END public void r102Implementation(Grid_Movimiento_Dev_Pte_VModel instance)
    }
}
