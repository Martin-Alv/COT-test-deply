...
namespace eaton.Rules
{
    public partial class Etiqueta_Proveedor1BusinessRules : eaton.Rules.SharedBusinessRules
    {
        ...
        /// <summary>Rule "Generar_Pdf_Etiqueta" implementation:
        /// This method will execute in any view for an action
        /// with a command name that matches "ReportAsPdf" and argument that matches "ExecCS06".
        /// </summary>
        [Rule("r111")]
        public void r111Implementation(Etiqueta_Proveedor1Model instance)
        {
            PreventDefault();
            ...
            else
            {
                ...
                options.Add("apikey", valorCualitativo);
                ...
                try
                {
                    byte[] reportData = client.UploadValues("http://api.html2pdfrocket.com/pdf", options);
