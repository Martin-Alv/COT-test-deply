...
namespace eaton.Rules
{
    ...
    {
        [AccessControl("Temporal_Carga_Masiva_Material1", "Carga", "[Carga] = @Carga")]
        public void RestringirPorMaxFecha()
        {
            ...
            sentenciaSQl = "SELECT TOP 1 ISNULL(MAX(Carga),0) AS Carga FROM dbo.Temporal_Carga_Masiva_Material WHERE Creado_Por_Id = '" + UserId.ToString() + "'";
