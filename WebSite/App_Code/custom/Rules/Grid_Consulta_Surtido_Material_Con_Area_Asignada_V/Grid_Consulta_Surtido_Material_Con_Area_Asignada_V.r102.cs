...
namespace eaton.Rules
{
	public partial class Grid_Consulta_Surtido_Material_Con_Area_Asignada_VBusinessRules : eaton.Rules.SharedBusinessRules
    {
        ...
        /// <summary>Rule "IniciarCapturaRemota" implementation:
        /// This method will execute in any view after an action
        /// with a command name that matches "Custom" and argument that matches "ExecCS03".
        /// </summary>
        [Rule("r102")]
        public void r102Implementation(Grid_Consulta_Surtido_Material_Con_Area_Asignada_VModel instance)
        {
            // This is the placeholder for method implementation.

            //Valores
            string Usuario_Id = UserId.ToString();// Id de Usuario logueado
            string Es_Captura_Local = "0";
            string Es_Captura_Remota = "1";
