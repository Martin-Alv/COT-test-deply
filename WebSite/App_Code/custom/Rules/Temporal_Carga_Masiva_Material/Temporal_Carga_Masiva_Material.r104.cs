...
namespace eaton.Rules
{
    public partial class Temporal_Carga_Masiva_MaterialBusinessRules : eaton.Rules.SharedBusinessRules
    {
        ...
        /// </summary>
        [Rule("r104")]
        public void r104Implementation(Temporal_Carga_Masiva_MaterialModel instance)
        {
            ...
            if (resultadoProcesarTemporalMaterial == false || (resultadoProcesarTemporalMaterial == true && mensajeSistemaId != 1))
            {
                ...
                Result.ExecuteOnClient("$appfactory.find('Temporal_Carga_Masiva_Material', 'Controller').sync();");
