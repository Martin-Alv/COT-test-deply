...
{
    public partial class Temporal_Etiqueta_Proveedor1_2_1_1BusinessRules : eaton.Rules.SharedBusinessRules
    {
        ...
        /// </summary>
        [Rule("r106")]
        public void r106Implementation(Temporal_Etiqueta_Proveedor1_2_1_1Model instance)
        {
            ...
            Result.ExecuteOnClient("$appfactory.find('Temporal_Etiqueta_Proveedor1_2_1_1', 'Controller').sync();");
            Result.ExecuteOnClient("$appfactory.find('Temporal_Etiqueta_Proveedor1_1', 'Controller').sync();");
            Result.ExecuteOnClient("$appfactory.find('Etiqueta_Proveedor1_1_1', 'Controller').sync();");
