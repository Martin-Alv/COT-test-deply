...
namespace eaton.Rules
{
    public partial class Etiqueta_Detalle_Proveedor1BusinessRules : eaton.Rules.SharedBusinessRules
    {
        ...
        /// </summary>
        [Rule("r105")]
        public void r105Implementation(Etiqueta_Detalle_Proveedor1Model instance)
        {
            ...
            {
                //todo salio bien, procedemos a generar el reporte, primero validamos si landscape es true o false para definir el formato del reporte.
                try
                {
