...
namespace eaton.Rules
{
	public partial class Grid_Orden_Detalle_De_Multiple_Orden_Prod_VBusinessRules : eaton.Rules.SharedBusinessRules
    {
        ...
        /// </summary>
        [Rule("r102")]
        // START public void r102Implementation(Grid_Orden_Detalle_De_Multiple_Orden_Prod_VModel instance)
        public void r102Implementation(Grid_Orden_Detalle_De_Multiple_Orden_Prod_VModel instance)
        {
            ...
            else
            {
                resultadoEjecucion = GenerarSolicitudMaterial(
                    ...
                    ,AreaServicioId
                    ,FamiliaId
                    , 11 //Solicitud creado desde materiales de varias ordenes.
                    //---                
                    , out MensajeSistema
        ...
        // END public void r102Implementation(Grid_Orden_Detalle_De_Multiple_Orden_Prod_VModel instance)
    }
}
