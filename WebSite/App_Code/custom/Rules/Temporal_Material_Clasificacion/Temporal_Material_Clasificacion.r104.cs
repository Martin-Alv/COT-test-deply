...
namespace eaton.Rules
{
    public partial class Temporal_Material_ClasificacionBusinessRules : eaton.Rules.SharedBusinessRules
    {
        ...
        /// </summary>
        [Rule("r104")]
        public void r104Implementation(Temporal_Material_ClasificacionModel instance)
        {
            ...
            if (resultadoProcesarMaterialClasificado == false || (resultadoProcesarMaterialClasificado == true && mensajeSistemaId != 1))
            {
                ...
                Result.ExecuteOnClient("$appfactory.find('Temporal_Material_Clasificacion', 'Controller').sync();");
