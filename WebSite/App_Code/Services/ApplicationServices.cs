...
namespace eaton.Services
{
        ...
        public static string ValidationKey
        {
            get
            {
                ...
                if (string.IsNullOrEmpty(key) || key.Contains("AutoGenerate"))
                    key = "87F6A225F3FD4F93B4352D64A3250F1DD480816E60BAD78DB6F69BC72929CE6C4948AF59CE2BE95EA" +
                        "D93E4A3A20C3A6E372AA522C6796DB12EBDCE9464F019B1";
                return key;
            }
        }
    ...
    public partial class ApplicationServicesBase
    {
                ...
                if (_defaultSettings == null)
                {
                    ...
                    if (_defaultSettings == null)
                    {
                        ...
                        if (_defaultSettings == null)
                        {
                            ...
                            EnsureJsonProperty(ui, "theme.accent", "Bittersweet");
                            EnsureJsonProperty(ui, "displayDensity.mobile", "Comfortable");
        ...
        {
            eaton.Services.ApplicationServices.Initialize();
        }
        ...
        public static void RegisterStandardMembershipAccounts()
        {
            if (AuthorizationIsSupported)
            {
                ...
                try
                {
                    ...
                    if (css == null)
                        css = ConfigurationManager.ConnectionStrings["eaton"];
                ...
                if (Membership.GetUser("admin") == null)
                {
                    ...
                    admin = Membership.CreateUser("admin", "admin123%", "admin@eaton.com", "ASP.NET", "Code OnTime", true, out status);
                    user = Membership.CreateUser("user", "user123%", "user@eaton.com", "ASP.NET", "Code OnTime", true, out status);
