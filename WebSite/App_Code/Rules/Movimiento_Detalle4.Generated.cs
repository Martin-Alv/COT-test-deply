...
{
    public partial class Movimiento_Detalle4BusinessRules : eaton.Rules.SharedBusinessRules
    {

        [RowBuilder("Movimiento_Detalle4", RowKind.New)]
        public void BuildNewMovimiento_Detalle4()
        {
