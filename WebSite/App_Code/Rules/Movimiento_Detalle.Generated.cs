...
{
    public partial class Movimiento_DetalleBusinessRules : eaton.Rules.SharedBusinessRules
    {

        [RowBuilder("Movimiento_Detalle", RowKind.New)]
        public void BuildNewMovimiento_Detalle()
        {
