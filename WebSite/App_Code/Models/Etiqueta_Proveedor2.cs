...
{
    public enum Etiqueta_Proveedor2DataField
    {
    ...
    public partial class Etiqueta_Proveedor2Model : BusinessRulesObjectModel
    {
        ...
        public Etiqueta_Proveedor2Model()
        {
        }

        public Etiqueta_Proveedor2Model(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[Etiqueta_Proveedor2DataField field]
        {
            get
            {
