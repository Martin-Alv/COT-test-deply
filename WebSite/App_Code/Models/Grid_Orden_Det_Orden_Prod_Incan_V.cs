...
{
    public enum Grid_Orden_Det_Orden_Prod_Incan_VDataField
    {
    ...
    public partial class Grid_Orden_Det_Orden_Prod_Incan_VModel : BusinessRulesObjectModel
    {
        ...
        public Grid_Orden_Det_Orden_Prod_Incan_VModel()
        {
        }

        public Grid_Orden_Det_Orden_Prod_Incan_VModel(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[Grid_Orden_Det_Orden_Prod_Incan_VDataField field]
        {
            get
            {
