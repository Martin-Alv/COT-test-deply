...
{
    public enum Grid_Material_Surtido_A_Ejecutar_VDataField
    {

        Tmp_Material_Surtido_Transaccion_Id,

        Numero_Grupo_Material_Surtido,
    ...
    public partial class Grid_Material_Surtido_A_Ejecutar_VModel : BusinessRulesObjectModel
    {
        ...
        [System.Diagnostics.DebuggerBrowsable(System.Diagnostics.DebuggerBrowsableState.Never)]
        private int? _numero_Grupo_Material_Surtido;
        ...
        public Grid_Material_Surtido_A_Ejecutar_VModel()
        {
        }

        public Grid_Material_Surtido_A_Ejecutar_VModel(BusinessRules r) :
                base(r)
        {
        }
        ...
        public int? Numero_Grupo_Material_Surtido
        {
            get
            {
                return _numero_Grupo_Material_Surtido;
            }
            set
            {
                _numero_Grupo_Material_Surtido = value;
                UpdateFieldValue("Numero_Grupo_Material_Surtido", value);
            }
        }
        ...
        public FieldValue this[Grid_Material_Surtido_A_Ejecutar_VDataField field]
        {
            get
            {
