...
{
    public enum Etiqueta_Detalle_Proveedor1DataField
    {
    ...
    public partial class Etiqueta_Detalle_Proveedor1Model : BusinessRulesObjectModel
    {
        ...
        public Etiqueta_Detalle_Proveedor1Model()
        {
        }

        public Etiqueta_Detalle_Proveedor1Model(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[Etiqueta_Detalle_Proveedor1DataField field]
        {
            get
            {
