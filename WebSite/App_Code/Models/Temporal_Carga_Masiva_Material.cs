...
{
    public enum Temporal_Carga_Masiva_MaterialDataField
    {
    ...
    public partial class Temporal_Carga_Masiva_MaterialModel : BusinessRulesObjectModel
    {
        ...
        public Temporal_Carga_Masiva_MaterialModel()
        {
        }

        public Temporal_Carga_Masiva_MaterialModel(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[Temporal_Carga_Masiva_MaterialDataField field]
        {
            get
            {
