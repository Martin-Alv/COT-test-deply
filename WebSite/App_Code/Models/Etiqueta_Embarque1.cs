...
{
    public enum Etiqueta_Embarque1DataField
    {
    ...
    public partial class Etiqueta_Embarque1Model : BusinessRulesObjectModel
    {
        ...
        public Etiqueta_Embarque1Model()
        {
        }

        public Etiqueta_Embarque1Model(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[Etiqueta_Embarque1DataField field]
        {
            get
            {
