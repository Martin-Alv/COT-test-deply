...
{
    public enum Etiqueta_Embarque_Detalle1DataField
    {
    ...
    public partial class Etiqueta_Embarque_Detalle1Model : BusinessRulesObjectModel
    {
        ...
        public Etiqueta_Embarque_Detalle1Model()
        {
        }

        public Etiqueta_Embarque_Detalle1Model(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[Etiqueta_Embarque_Detalle1DataField field]
        {
            get
            {
