...
{
    public enum Temporal_Material_Clasificacion1DataField
    {
    ...
    public partial class Temporal_Material_Clasificacion1Model : BusinessRulesObjectModel
    {
        ...
        public Temporal_Material_Clasificacion1Model()
        {
        }

        public Temporal_Material_Clasificacion1Model(BusinessRules r) :
                base(r)
        {
        }
        ...
        public string Temporal_Material_Clasificacion
        {
            get
            {
            ...
            set
            {
                ...
                UpdateFieldValue("Temporal_Material_Clasificacion", value);
            }
        }
        ...
        public FieldValue this[Temporal_Material_Clasificacion1DataField field]
        {
            get
            {
