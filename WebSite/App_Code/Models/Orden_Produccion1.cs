...
{
    public enum Orden_Produccion1DataField
    {
    ...
    public partial class Orden_Produccion1Model : BusinessRulesObjectModel
    {
        ...
        public Orden_Produccion1Model()
        {
        }

        public Orden_Produccion1Model(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[Orden_Produccion1DataField field]
        {
            get
            {
