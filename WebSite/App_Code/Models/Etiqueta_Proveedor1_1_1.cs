...
{
    public enum Etiqueta_Proveedor1_1_1DataField
    {
    ...
    public partial class Etiqueta_Proveedor1_1_1Model : BusinessRulesObjectModel
    {
        ...
        public Etiqueta_Proveedor1_1_1Model()
        {
        }

        public Etiqueta_Proveedor1_1_1Model(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[Etiqueta_Proveedor1_1_1DataField field]
        {
            get
            {
