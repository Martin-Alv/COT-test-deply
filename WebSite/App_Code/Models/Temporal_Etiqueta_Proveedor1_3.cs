...
{
    public enum Temporal_Etiqueta_Proveedor1_3DataField
    {
    ...
    public partial class Temporal_Etiqueta_Proveedor1_3Model : BusinessRulesObjectModel
    {
        ...
        public Temporal_Etiqueta_Proveedor1_3Model()
        {
        }

        public Temporal_Etiqueta_Proveedor1_3Model(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[Temporal_Etiqueta_Proveedor1_3DataField field]
        {
            get
            {
