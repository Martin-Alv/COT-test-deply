...
{
    public enum Grid_Ruta_Optima_A_Ejecutar_VDataField
    {
    ...
    public partial class Grid_Ruta_Optima_A_Ejecutar_VModel : BusinessRulesObjectModel
    {
        ...
        public Grid_Ruta_Optima_A_Ejecutar_VModel()
        {
        }

        public Grid_Ruta_Optima_A_Ejecutar_VModel(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[Grid_Ruta_Optima_A_Ejecutar_VDataField field]
        {
            get
            {
