...
{
    public enum Temporal_Carga_Masiva_Material3DataField
    {
    ...
    public partial class Temporal_Carga_Masiva_Material3Model : BusinessRulesObjectModel
    {
        ...
        public Temporal_Carga_Masiva_Material3Model()
        {
        }

        public Temporal_Carga_Masiva_Material3Model(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[Temporal_Carga_Masiva_Material3DataField field]
        {
            get
            {
