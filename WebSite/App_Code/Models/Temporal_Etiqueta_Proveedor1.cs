...
{
    public enum Temporal_Etiqueta_Proveedor1DataField
    {
    ...
    public partial class Temporal_Etiqueta_Proveedor1Model : BusinessRulesObjectModel
    {
        ...
        public Temporal_Etiqueta_Proveedor1Model()
        {
        }

        public Temporal_Etiqueta_Proveedor1Model(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[Temporal_Etiqueta_Proveedor1DataField field]
        {
            get
            {
