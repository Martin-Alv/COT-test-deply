...
{
    public enum Temporal_Etiqueta_Proveedor1_1DataField
    {
    ...
    public partial class Temporal_Etiqueta_Proveedor1_1Model : BusinessRulesObjectModel
    {
        ...
        public Temporal_Etiqueta_Proveedor1_1Model()
        {
        }

        public Temporal_Etiqueta_Proveedor1_1Model(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[Temporal_Etiqueta_Proveedor1_1DataField field]
        {
            get
            {
