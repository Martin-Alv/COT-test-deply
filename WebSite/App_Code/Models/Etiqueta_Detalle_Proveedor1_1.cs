...
{
    public enum Etiqueta_Detalle_Proveedor1_1DataField
    {
    ...
    public partial class Etiqueta_Detalle_Proveedor1_1Model : BusinessRulesObjectModel
    {
        ...
        public Etiqueta_Detalle_Proveedor1_1Model()
        {
        }

        public Etiqueta_Detalle_Proveedor1_1Model(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[Etiqueta_Detalle_Proveedor1_1DataField field]
        {
            get
            {
