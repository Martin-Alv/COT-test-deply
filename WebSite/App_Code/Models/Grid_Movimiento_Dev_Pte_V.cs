...
{
    public enum Grid_Movimiento_Dev_Pte_VDataField
    {
    ...
    public partial class Grid_Movimiento_Dev_Pte_VModel : BusinessRulesObjectModel
    {
        ...
        public Grid_Movimiento_Dev_Pte_VModel()
        {
        }

        public Grid_Movimiento_Dev_Pte_VModel(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[Grid_Movimiento_Dev_Pte_VDataField field]
        {
            get
            {
