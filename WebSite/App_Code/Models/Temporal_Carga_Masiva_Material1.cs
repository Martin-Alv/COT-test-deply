...
{
    public enum Temporal_Carga_Masiva_Material1DataField
    {
    ...
    public partial class Temporal_Carga_Masiva_Material1Model : BusinessRulesObjectModel
    {
        ...
        public Temporal_Carga_Masiva_Material1Model()
        {
        }

        public Temporal_Carga_Masiva_Material1Model(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[Temporal_Carga_Masiva_Material1DataField field]
        {
            get
            {
