...
{
    public enum Escaneo_Validador_Embarque1_1DataField
    {
    ...
    public partial class Escaneo_Validador_Embarque1_1Model : BusinessRulesObjectModel
    {
        ...
        public Escaneo_Validador_Embarque1_1Model()
        {
        }

        public Escaneo_Validador_Embarque1_1Model(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[Escaneo_Validador_Embarque1_1DataField field]
        {
            get
            {
