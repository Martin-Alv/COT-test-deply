...
{
    public enum Etiqueta_Proveedor1DataField
    {
    ...
    public partial class Etiqueta_Proveedor1Model : BusinessRulesObjectModel
    {
        ...
        public Etiqueta_Proveedor1Model()
        {
        }

        public Etiqueta_Proveedor1Model(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[Etiqueta_Proveedor1DataField field]
        {
            get
            {
