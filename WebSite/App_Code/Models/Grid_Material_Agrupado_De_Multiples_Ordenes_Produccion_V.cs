...
{
    public enum Grid_Material_Agrupado_De_Multiples_Ordenes_Produccion_VDataField
    {
    ...
    public partial class Grid_Material_Agrupado_De_Multiples_Ordenes_Produccion_VModel : BusinessRulesObjectModel
    {
        ...
        public Grid_Material_Agrupado_De_Multiples_Ordenes_Produccion_VModel()
        {
        }

        public Grid_Material_Agrupado_De_Multiples_Ordenes_Produccion_VModel(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[Grid_Material_Agrupado_De_Multiples_Ordenes_Produccion_VDataField field]
        {
            get
            {
