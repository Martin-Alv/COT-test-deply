...
{
    public enum Temporal_Etiqueta_Proveedor1_2DataField
    {
    ...
    public partial class Temporal_Etiqueta_Proveedor1_2Model : BusinessRulesObjectModel
    {
        ...
        public Temporal_Etiqueta_Proveedor1_2Model()
        {
        }

        public Temporal_Etiqueta_Proveedor1_2Model(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[Temporal_Etiqueta_Proveedor1_2DataField field]
        {
            get
            {
